...
- раздел **Настройки → Подключение** — безопасный просмотр и opt-in изменение
  IntraService/Telegram без раскрытия токенов и паролей;
- раздел **Настройки → Доступ** — управление whitelist пользователей;
